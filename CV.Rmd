...
```{r}
if(PDF_EXPORT){
  glue("View this CV online with links at _{}_")
} else {
  glue("[<i class='fas fa-download'></i> Download a PDF of this CV]({})")
}
```
...
ggplot(data, aes(x = Dens)) + 
  geom_line(aes(color = Cat), stat = "density", size = 1, alpha = 0.8, show.legend = FALSE) +
...
- <i class="fa fa-envelope"></i> [Email/jSoboil](soboil.joshua@gmail.com)
- <i class="fa fa-github"></i> [github.com/jSoboil](https://github.com/jSoboil)
- <i class="fa fa-linkedin"></i> [LinkedIn/jSoboil](https://www.linkedin.com/in/joshua-soboil-067351172/)
...
ggplot(aes(skill, level)) +
  geom_bar(aes(x = reorder(skill, level), y = level, alpha = .5),
           stat = "identity", show.legend = FALSE, fill = "grey81") +
...
Joshua is seeking to develop his career in the Health Economics consultancy field. He is interested in Health Technology Assessment and other HEOR and Market Access roles.
...
Thesis: A Framework for Incorporating a Fully-Integrated Bayesian Approach to Cost-Effectiveness Evaluations for Low- and Middle-Income Country Contexts
...
Thesis: Astronomy in the Age of Big Data [Read here](https://cosmopolitankaroo.co.za/wp-content/uploads/2017/04/J-Musson-Honours-Research-Report-final-March-2019.pdf)
...
- Lead capacity development strategist.
- Ensuring the establishment and development of sustainable funding networks and strategies.
:::
...
- Reviewed South African Community Based Monitoring (CBM) tools. 
- Focused on Service Delivery and government accountability; at both local and national levels.
:::


### Data Capturer

SACTWU Worker Health
...
::: concise
- Capturing of first year quarter data for worker mobile health programmes across Western Cape.
:::
...
Volunteering {data-icon=hand-paper}
--------------------------------------------------------------------------------
...
Provided career mentorship to underprivileged matriculatant learners enrolled in the Inkhamva Youth programme.
