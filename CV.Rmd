...
::: concise
- Founding member of the R-HTA in LMICs chapter
- [R-HTA](https://r-hta.org/) is a consortium focused on popularising the use of R for health economics and health technology assessment (HTA)
- Developed quarterly workshops, teaching basic to advanced health economic modelling topics
:::
