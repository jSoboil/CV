...
Seeking to develop career in the HEOR field. Undergraduate degree provided a mature and holistic understanding of socio-economic processes. An eye for detail and deep intrigue for statistics and economics spurred on the development of skills that were more than required for Master's. Thus, has additionally required deep quantitative skills with a high programming proficiency. 

From having experience in diverse backgrounds, provides a uniquely diverse skill set. Particularly interested in developing cost-effectiveness models and other HTA roles.
...
Thesis title: A Decision Framework for Conducting Comprehensive Decision Analytic Modelling in Middle-Income Country Contexts.
...
- Ensured establishment and development of sustainable funding networks and strategies for the future growth of the organisation.
:::
